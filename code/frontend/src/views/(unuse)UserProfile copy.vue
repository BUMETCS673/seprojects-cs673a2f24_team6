<template>
      ...
      <div class="profile-details">
        ...
        <div class="row">
          ...
          <div class="column">
            ...
            <input type="text" v-model="user.part" />
          </div>
        </div>
        ...
        <div class="row">
          <div class="column">
            ...
            <input type="date" v-model="user.startDate" />
          </div>
          <div class="column">
      ...
      <div class="contact-address-section">
        <div class="contacts">
          ...
          <div class="contact-details">
            ...
            <label>Favorite Training Period:</label>
            <input type="text" v-model="user.trainperiod" />
          </div>
        </div>
      </div>
  ...
  export default {
    data() {
      return {
        profilePhotoUrl: 'default-photo.jpg', 
        user: {
          id: '22',
          firstName: ' ',
          lastName: ' ',
